...
export default {
  ...
  cameraXInput: q<HTMLInputElement>("camera-x"),
  cameraYInput: q<HTMLInputElement>("camera-y"),
  cameraZInput: q<HTMLInputElement>("camera-z"),
  lookXInput: q<HTMLInputElement>("lookat-x"),
  lookYInput: q<HTMLInputElement>("lookat-y"),
  lookZInput: q<HTMLInputElement>("lookat-z"),
  ...
  resetButton: q<HTMLButtonElement>("reset-btn"),
